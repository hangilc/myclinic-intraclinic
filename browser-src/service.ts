...
export async function enterIntraclinicPost(content: string): Promise<number> {
	return request("/service", {
...
export async function enterIntraclinicComment(name: string, content: string, postId: number): Promise<number> {
	return request("/service", {
